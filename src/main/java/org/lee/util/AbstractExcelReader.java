...
public abstract class AbstractExcelReader implements ExcelReader {
    ...
    protected String getStringCellValue(Row row, int cloumn, String errorMessage) throws DataInvalidException {
    ...
    protected String getNullOrNumStringCellValue(Row row, int cloumn, String errorMessage) throws DataInvalidException {
    ...
    protected String getNullOrStringCellValue(Row row, int cloumn, String errorMessage) throws DataInvalidException {
        Cell cell = row.getCell(cloumn);
    ...
    protected boolean isStringCell(Cell cell) throws DataFormatException {
